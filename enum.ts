export enum homePageContent{
    ...
    endClientsServiceModelsOnCallAssignment = "Short-term, high-burn assignment wherein immediate and time critical asks are delivered. (hourly rates apply)",
    consultingFirms1 = "Micro assignments wherein we deliver on specific tasks assigned by large and boutique consulting firms",
    consultingFirms2 = "Availability of competent and experienced resources on a temporary basis for undertaking specific tasks",
    chooseUsPracticalSolutions = "We are committed towards delivering solutions that are pragmatic and applicable in the real world of business",
    chooseUsInDepthResearch = "Our team is focused on undertaking in-depth research and case analysis to provide relevant results to our clients",
    chooseUsIndustryExpertise = "We have deep experience and understanding around the functioning of multiple industries in multiple sectors",
